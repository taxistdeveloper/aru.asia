...
/**
 * ПАНЕЛЬ МЕНЕДЖЕРА - УПРАВЛЕНИЕ ОБРАТНОЙ СВЯЗЬЮ
 */
...
<div class="mt-4">
    ...
    <!-- Фильтры -->
    <div class="mb-3">
        <a href="<?= BASE_URL ?>manager/feedback" class="btn btn-sm <?= $currentStatus === 'all' ? 'btn-primary' : 'btn-outline-primary' ?>">
            Все
        </a>
        <a href="<?= BASE_URL ?>manager/feedback?status=new" class="btn btn-sm <?= $currentStatus === 'new' ? 'btn-warning' : 'btn-outline-warning' ?>">
            Новые (<?= $stats['new'] ?>)
        </a>
        <a href="<?= BASE_URL ?>manager/feedback?status=in_progress" class="btn btn-sm <?= $currentStatus === 'in_progress' ? 'btn-info' : 'btn-outline-info' ?>">
            В работе
        </a>
        <a href="<?= BASE_URL ?>manager/feedback?status=resolved" class="btn btn-sm <?= $currentStatus === 'resolved' ? 'btn-success' : 'btn-outline-success' ?>">
            Решено
        </a>
        <a href="<?= BASE_URL ?>manager/feedback?status=closed" class="btn btn-sm <?= $currentStatus === 'closed' ? 'btn-secondary' : 'btn-outline-secondary' ?>">
            Закрыто
        </a>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <form method="POST" action="<?= BASE_URL ?>manager/feedback/delete" class="d-inline" onsubmit="return confirm('Вы уверены, что хотите удалить эту заявку?');">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <?php if ($item['admin_notes']): ?>
                                                    <div class="mb-3">
                                                        <strong>Заметки менеджера:</strong>
                                                ...
                                                <form method="POST" action="<?= BASE_URL ?>manager/feedback/update-status">
                                                    <input type="hidden" name="feedback_id" value="<?= $item['id'] ?>">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="admin_notes<?= $item['id'] ?>" class="form-label">Заметки менеджера</label>
...
$title = 'Обратная связь - Панель менеджера';
